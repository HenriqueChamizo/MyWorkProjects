...
function acquireImage() {
	...
	if(DWObject.ErrorCode != 0)
	{
	    ...
	    appendMessage('<b>Uma ESCALA precisa estar selecionada: </b>');
		appendMessage("<span style='color:#cE5E04'><b>" + DWObject.ErrorString + "</b></span><br />");
	}
	...
	{
	    //appendMessage('<b>Error setting Resolution value: </b>');
	    appendMessage('<b>Uma RESOLUÇÃO precisa estar selecionada: </b>');
		appendMessage("<span style='color:#cE5E04'><b>" + DWObject.ErrorString + "</b></span><br />");
	}
...
function btnLoad_onclick() {
    var OnSuccess = function() {
        appendMessage("Carregamento de imagem foi um sucesso.<br/>");
        updatePageInfo();
    };
...
function saveUploadImage(type){
	if(type=='local'){
	    ...
	    //var _rdPDF = document.getElementById("imgTypepdf");
	    //_rdPDF.disabled = false;
	    //_rdPDF.checked = true;
...
function btnUpload_onclick() {
    ...
    DWObject.MaxUploadImageSize = -1;
    
    var CurrentPathName = unescape(location.pathname); // get current PathName in plain ASCII	
    var CurrentPathName2 = CurrentPathName.substring(0, CurrentPathName.lastIndexOf("/"));
    var CurrentPath = CurrentPathName2.substring(0, CurrentPathName2.lastIndexOf("/") + 1);
    //strActionPage = "/ExtraActions/SaveToFile.aspx"; //the ActionPage's file path , Online Demo:"SaveToDB.aspx" ;Sample: "SaveToFile.aspx";
    //var query = window.location;
    //var split = query.toString().split('/');
    //var id = split[split.length - 1];
    var id = document.getElementById("indiceLote").value;
    strActionPage = CurrentPath + "Arquivo/Salvar/" + id;// + DWObject.HowManyImagesInBuffer; //the ActionPage's file path , Online Demo:"SaveToDB.aspx" ;Sample: "SaveToFile.aspx";
    //strActionPage = CurrentPath + "SaveToFile.aspx";
    var redirectURLifOK = CurrentPath + "Lote/Detail/" + id;
    //for (i = 0; i < 5; i++) {
	...
	var uploadfilename = fileName + "." + "pdf";//document.getElementsByName("ImageType").item(i).value;
	...
	DWObject.HTTPUploadAllThroughPostAsPDF(strHTTPServer, strActionPage, uploadfilename, [OnSuccess, OnFailure]);
	window.location.href = redirectURLifOK;
}
