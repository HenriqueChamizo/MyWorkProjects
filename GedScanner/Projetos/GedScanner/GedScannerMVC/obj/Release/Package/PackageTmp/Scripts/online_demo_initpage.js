...
var CurrentPath = CurrentPathName.substring(0, CurrentPathName.lastIndexOf("/") + 3);
...
function pageonload() {    
    ...
    if (twainsource) {
        ...
        twainsource.options.add(new Option("Procurando dispositivos...", 0));
...
function initCustomScan() {
    ...
    if (Dynamsoft.Lib.env.bWin)
        ObjString += "<div id='divWebcamType' class='row'>";
    else
        ObjString += "<div id='divWebcamType' class='row'>";
    ObjString += "<div class='col-sm-4'>";
    ObjString += "<label for = 'ShowUIForWebcam'><input type='checkbox' id='ShowUIForWebcam' />Show UI&nbsp;</label></div>";
    if (Dynamsoft.Lib.env.bWin) {
        ObjString += "<div class='col-sm-4'>";
        ObjString += "<label for='MediaType'>Media Type:<select size='1' id='MediaType' onchange='mediaType_onchange()'><option value = ''></option></select></label></div>";
        ObjString += "<div class='col-sm-4'>";
        ObjString += "<label for='Resolution'>Resolution:&nbsp;<select size='1' id='ResolutionWebcam'><option value = ''></option></select></label></div>";
    }
    ObjString += "</div>";
    ...
    ObjString = "";
    ObjString += "<div id='divTwainType' class='row'> ";
    ObjString += "<div class='col-sm-4'>";
    ...
    ObjString += "<div class='col-sm-4'>Pixel Type:";
    ...
    ObjString += "<div class='col-sm-4 form-inline'>";
    ObjString += "<label for='Resolution'>Resolution:<select size='1' id='Resolution' class='form-control'><option value = ''></option></select></label></div>";
    ObjString += "</div>";
...
function setDefaultValue() {
    var vShowUI = document.getElementById("ShowUI");
    if (vShowUI)
        vShowUI.checked = true;
...
function checkIfImagesInBuffer() {
    if (DWObject.HowManyImagesInBuffer == 0) {
        appendMessage("É preciso ter Scaneado alguma imagem.<br />")
        return false;
    }
    else
        return true;
